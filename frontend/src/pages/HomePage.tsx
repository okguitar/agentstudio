    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                ...
                <span>{t('createCustomAgent')}</span>
              </button>
              <span className="text-sm text-gray-500">{t('agentCount', { count: enabledAgents.length })}</span>
            </div>
          </div>
        ...
        {disabledAgents.length > 0 && (
          <div>
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-semibold text-gray-700">{t('disabledAgents')}</h2>
              <span className="text-sm text-gray-500">{t('agentCount', { count: disabledAgents.length })}</span>
            </div>
