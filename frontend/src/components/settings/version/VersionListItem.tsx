      ...
      <div className="flex items-center justify-between">
        <div className="flex-1">
            ...
            <h4 className="font-medium text-gray-900 dark:text-white flex items-center space-x-2">
              ...
              {isDefault && (
                <span className="px-2 py-1 text-xs bg-blue-200 dark:bg-blue-700 text-blue-700 dark:text-blue-200 rounded flex items-center space-x-1">
                  ...
                  <span>{t('settings.supplier.defaultLabel')}</span>
                </span>
              )}
            </h4>
          </div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
            <span className="font-medium">{t('settings.supplier.pathLabel')}:</span> {version.executablePath}
          </p>
          {version.environmentVariables && Object.keys(version.environmentVariables).length > 0 && (
            <div className="mt-2">
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                {t('settings.supplier.envVarsLabel')}:
              </span>
          ...
          {version.models && version.models.length > 0 && (
            <div className="mt-2">
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                {t('settings.supplier.modelsLabel')}:
              </span>
              <div className="flex flex-wrap gap-2 mt-1">
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            title={t('settings.supplier.copyCommand')}
          >
          ...
          {!isDefault && (
            <button
              ...
              title={t('settings.supplier.setAsDefault')}
            >
          ...
          <button
            ...
            title={t('settings.supplier.edit')}
          >
          ...
          {!version.isSystem && (
            <button
              ...
              title={t('settings.supplier.delete')}
            >
